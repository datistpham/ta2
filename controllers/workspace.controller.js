...
export const createTaskInWorkspace = async (req, res) => {
    ...
    try {
        ...
        const newTask = new Task({
            ...
            starting_time: (taskData.startTime),
        ...
        return res.status(201).json({ message: "Create task is success", data: saveTask });
    } catch (error) {
...
export const updateTask = async (req, res) => {
    ...
    try {
        ...
        // Sử dụng Mongoose để tìm và cập nhật công việc
...
export const deleteTask = async (req, res) => {
    ...
    try {
        ...
        // Sử dụng Mongoose để tìm và xóa công việc
